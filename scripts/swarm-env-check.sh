...
CANONICAL_REPO="/Users/aurora/hermeschi"
FORBIDDEN_REPO="/Users/aurora/hermeschi"
...
pkg = json.loads(Path('/Users/aurora/hermeschi/package.json').read_text())
print(pkg.get('name', ''))
PY
)"

if [[ "$REPO_NAME" != "hermeschi" ]]; then
