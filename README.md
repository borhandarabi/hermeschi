...
```bash
curl -fsSL https://raw.githubusercontent.com/borhandarabi/hermeschi/main/install.sh | bash
```
...
[![Open in GitHub Codespaces](https://img.shields.io/badge/GitHub%20Codespaces-Open-181717?logo=github)](https://github.com/codespaces/new?hide_repo_select=true&ref=main&repo=borhandarabi/hermeschi)
...
- **hermeschi** → `ghcr.io/borhandarabi/hermeschi:latest` روی پورت **3000**
...
```
ghcr.io/borhandarabi/hermeschi:latest
```
...
```yaml
service: hermeschi
image: ghcr.io/borhandarabi/hermeschi:latest
port: 3000
env:
...
(اگر از مسیر متفاوتی نصب کرده‌اید، دستورات ارتقای نصب‌کنندهٔ Nous خود را دنبال کنید.) اگر روی فورک قدیمی `borhandarabi/hermes-agent` بودید، از نسخهٔ ۲ به بعد دیگر نیازی به آن نیست — آن را حذف کنید و به‌جای آن از upstream استفاده کنید.
...
| قابلیت | وضعیت |
|---|---|
| مأموریت‌های Conductor | رابط کاربری فضای کاری تحویل شده؛ در صورت موجود بودن از API مأموریت داشبورد و در غیر این صورت از fallback Swarm بومی فضای کاری استفاده می‌کند (به [#262](https://github.com/borhandarabi/hermeschi/issues/262) مراجعه کنید) |
...
## [![Star History Chart](https://api.star-history.com/svg?repos=borhandarabi/hermeschi&type=date&logscale&legend=top-left)](https://www.star-history.com/#borhandarabi/hermeschi&type=date&logscale&legend=top-left)
...
[![GitHub Sponsors](https://img.shields.io/badge/Sponsor-%E2%9D%A4-pink?logo=github)](https://github.com/sponsors/borhandarabi)
...
<div align="center">
  <sub>ساخته‌شده با ⚡ توسط <a href="https://github.com/borhandarabi">@borhandarabi</a> و جامعهٔ HermesChi</sub>
</div>
