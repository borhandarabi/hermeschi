...
ابزار CLI سبک پایتون که مجموع اندازهٔ تمام فایل‌های زیر یک دایرکتوری مشخص را به‌صورت بازگشتی محاسبه می‌کند. اهداف طراحی: فقط خواندن، سریع، خروجی ساختاریافته، و قابل استفاده به‌عنوان ابزار اعتبارسنجی برای آزمون اصلاح @mention.
