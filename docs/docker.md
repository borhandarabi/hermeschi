...
اگر راه‌اندازی شما با راهنمای بالا همخوانی دارد ولی باز هم می‌شکند، یک issue در <https://github.com/borhandarabi/hermeschi/issues> ثبت کنید و این موارد را ضمیمه کنید:
