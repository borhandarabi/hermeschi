...
export const HERMESCHIWORLD_CHARACTER_ARCHETYPES: CharacterArchetype[] = [
  {
    id: 'player-adventurer',
    label: 'Player Adventurer',
    zone: 'agora',
    role: 'player',
    modelPath: '/assets/hermeschiworld/characters/player-adventurer.glb',
    defaultScale: 1,
  ...
  },
  {
    ...
    zone: 'oracle',
    role: 'npc',
    modelPath: '/assets/hermeschiworld/characters/oracle-scholar.glb',
    defaultScale: 1,
  ...
  },
  {
    ...
    zone: 'forge',
    role: 'npc',
    modelPath: '/assets/hermeschiworld/characters/forge-blacksmith.glb',
    defaultScale: 1,
  ...
  },
  {
    ...
    zone: 'agora',
    role: 'npc',
    modelPath: '/assets/hermeschiworld/characters/guard-knight.glb',
    defaultScale: 1,
  ...
  },
  {
    ...
    zone: 'agora',
    role: 'npc',
    modelPath: '/assets/hermeschiworld/characters/merchant-villager.glb',
    defaultScale: 1,
  ...
  },
  {
    ...
    role: 'npc',
    modelPath: '/assets/hermeschiworld/characters/villager-common.glb',
    defaultScale: 1,
...
export const HERMESCHIWORLD_CHARACTER_PIPELINE_NOTES = {
