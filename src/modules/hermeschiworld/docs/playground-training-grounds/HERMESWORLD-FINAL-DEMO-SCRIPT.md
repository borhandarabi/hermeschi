# HermesChiWorld — Final Demo Script
...
| # | Beat | Time | Notes |
|---|---|---|---|
| 1 | Title screen — show **HermesChiWorld** gold serif title, "the agent MMO" tagline, premium gold "Enter the Realm" CTA | 0:00 – 0:08 | Type your name. Click Customize Avatar briefly to show the Sims-lite picker, then close. |
...
1. **Title screen**: "HermesChi turns agent onboarding into a multiplayer RPG. This is **HermesChiWorld** — a 3D realm where you don't read about Hermes, you play it."
...
7. **End**: "HermesChiWorld. The fastest way to teach builders what Hermes Agent actually feels like."
...
| | |
|---|---|
| Title screen — HermesChiWorld branding, gold serif, premium feel | ✅ |
...
gh pr create \
  --title "HermesChiWorld: agent MMO with full multiplayer" \
  --body "$(cat memory/goals/2026-05-03-playground-training-grounds/HERMESCHIWORLD-FINAL-DEMO-SCRIPT.md)"
```
