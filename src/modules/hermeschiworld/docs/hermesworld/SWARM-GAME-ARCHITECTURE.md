# HermesChiWorld Swarm Game Architecture

Last updated: 2026-05-06

## Core idea

HermesChiWorld should be built like an agent-native game studio:
...
- HermesChi embeds hosted HermesChiWorld via iframe.
- HermesChiWorld runtime lives on `hermeschi-world.ai`.
...
Goal: make HermesChiWorld playable on phones.
