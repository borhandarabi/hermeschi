# HermesChiWorld Guild/Event/Economy Contracts

Last updated: 2026-05-06

## Goal

Define safe client/server data contracts for HermesChiWorld guild creation, weekend wars, raids, leaderboards, Founders Vault, and chat trade. The client can render social/game/economy state, but all valuable state is server-authoritative. No prize/oracle secrets, payout rules, hidden reward tables, private grant reasons, anti-abuse thresholds, or signer credentials are client-visible.
...
- POST /private/hermeschiworld/event-grants/create
- POST /private/hermeschiworld/event-grants/revoke
- POST /private/hermeschiworld/war/finalize-score
- POST /private/hermeschiworld/war/grant-rewards
- POST /private/hermeschiworld/raid/finalize-loot
- POST /private/hermeschiworld/leaderboards/finalize
- POST /private/hermeschiworld/trades/settle-hard-currency
- POST /private/hermeschiworld/oracle/validate-prize-eligibility
- POST /private/hermeschiworld/audit/events
