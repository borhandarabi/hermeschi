# HermesChiWorld Asset Generation V2 Status
...
- Zone variants and selected zone heroes: `public/assets/hermeschiworld/zones/v2/`
- NPC portraits: `public/avatars/v2/`
- Icon sprite sheet and manifest: `public/assets/hermeschiworld/icons/sprite-v1.png` and `sprite-v1.json`
- Video poster: `public/assets/hermeschiworld/video/world-demo-poster-v2.jpg`

## Prompt source

Use `docs/hermeschiworld/PROMPT-LIBRARY.md` for the exact repeatable prompts and style lock values.
