# HermesChiWorld Vision — The Best AI MMO

Last updated: 2026-05-06

## One-liner

HermesChiWorld is Roblox + MMORPG + AI agents + prize hunts: a browser-native world where humans and their agents explore, quest, party up, build guilds, compete in minigames, and discover real rewards.
...
- HermesChi: OSS shell/embed/distribution
- HermesChiWorld.ai: hosted game runtime
...
HermesChiWorld turns agents into characters, tools into quests, model evals into arenas, and community into a world.
