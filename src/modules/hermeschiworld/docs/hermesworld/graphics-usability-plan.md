# HermesChiWorld Graphics + Usability Development Plan

Status: start now
Owner: Eric / Aurora
Stack: HermesChi + React + Three.js / React Three Fiber

## Goal

Upgrade HermesChiWorld from "promising web demo" to "serious playable world" with:
...
5. adapt wardrobe/colors to HermesChiWorld visual language
