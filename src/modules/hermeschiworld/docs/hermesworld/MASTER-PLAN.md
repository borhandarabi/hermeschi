...
- `outsourc-e/hermeschiworld-game` — **private** (issues, internal specs, prize logic, secrets, roadmap)
...
3. Private repo `outsourc-e/hermeschiworld-game` created with labels + issue templates
