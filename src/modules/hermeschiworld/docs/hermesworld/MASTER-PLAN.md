# HermesChiWorld — Master Plan (Single Source of Truth)
...
HermesChiWorld = the first **Agentic MMO**.
...
- **Marketing/store page spec**: `docs/hermeschiworld/reference-images/MASTER-PRODUCT-GRAPHIC.png`
- **Playable in-game spec**: `docs/hermeschiworld/reference-images/INGAME-TARGET-AGORA.png`
...
- `borhandarabi/hermeschi` — public (browser game lives here)
- `borhandarabi/hermeschiworld-game` — **private** (issues, internal specs, prize logic, secrets, roadmap)
- `borhandarabi/controlsuite` — desktop client
- `ocplatform/ocplatform` — agent runtime
- `ocplatform/ocplatform-control-ui` — webchat surface

## 5. Asset replacement waves (right order)

We replace HermesChiWorld's art batch by batch, never all at once.
...
3. Private repo `borhandarabi/hermeschiworld-game` created with labels + issue templates
...
5. Name reservation page (form on hermeschi-world.ai)
...
| Goal ID | File | State |
| --- | --- | --- |
| 2026-05-06-hermeschiworld-swarm-game-studio | `memory/goals/2026-05-06-hermeschiworld-swarm-game-studio/` | active |
| 2026-05-06-hermeschiworld-master-plan | this file | active |

When new goals are spawned, register them here so future agents see them.

## 8. Existing companion docs

- `docs/hermeschiworld/INGAME-TARGET-SPEC.md` — playable view target breakdown
- `docs/hermeschiworld/AGENTIC-WOW-ROHAN-SYSTEMS.md` — class/skill/raid systems
- `docs/hermeschiworld/GUILDS-AGENTS-COMPANION-ECONOMY.md` — guild + agent + monetization
- `docs/hermeschiworld/VISION-BEST-AI-MMO.md` — north star
- `docs/hermeschiworld/ART-BIBLE-REALISM-LOOP.md` — image gen → review loop
- `docs/hermeschiworld/AGORA-INSO-IMPLEMENTATION.md` — Agora hub upgrade plan
- `docs/hermeschiworld/AGORA-INSO-ASSET-PROMPTS.md` — concrete prompt pack
- `skills/video-game-building/` — reusable game-build skill

## 9. Bug + community input pipeline

- Public face: `hermeschi-world.ai/feedback` form
...
1. Read this file.
2. Read `docs/hermeschiworld/MASTER-PRODUCT-GRAPHIC.png`.
3. Read `memory/goals/2026-05-06-hermeschiworld-swarm-game-studio/goal.spec.md` and `state.json`.
