...
```bash
VITE_PLAYGROUND_WS_URL=wss://hermeschi-playground-ws.<your-subdomain>.workers.dev/playground
VITE_PLAYGROUND_STATS_URL=https://hermeschi-playground-ws.<your-subdomain>.workers.dev/stats
```

(Custom domain optional via Workers Routes — `wss://hub.hermeschi-playground.app`.)
