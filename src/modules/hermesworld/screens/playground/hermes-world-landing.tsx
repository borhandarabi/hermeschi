...
const HERMES_ROADMAP_URL = 'https://github.com/outsourc-e/hermeschi/blob/main/docs/hermesworld/master-roadmap.md'
const HERMES_DOCS_URL = 'https://github.com/outsourc-e/hermeschi/tree/main/docs/hermesworld'
  ...
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-[880px] rounded-[2rem] border border-[#d9b35f]/24 bg-[#05080e]/78 p-8 text-center shadow-[0_40px_140px_rgba(0,0,0,.52)] backdrop-blur-xl sm:p-12">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-[#d7d0bd]/62">Enter HermesWorld and explore the first playable layer of HermesChi: zones, quests, companions, sigils, and persistent agent progression.</p>
