...
The target is browser-first. HermesWorld can be embedded inside HermesChi and hosted through HermesWorld.ai. Future installable/PWA clients may arrive later.
